function Bear() {
    ...
    this.move = function(xDir, yDir) {
        this.fitBounds(); //we add this instruction to keep the bear within board
 ...
 function createBeeImg(wNum){
     ...
     let boardDivH = boardDivH.offsetHeight;
     ...
     img.setAttribute("class","bee"); //set class of the html tag img
 ...
 function isHit(defender,offender){
     if (overlap(defender,offender)){//check if the two image overlap
         ...
         let newStringTime = new Date();
         let thisDuration = newStringTime - lastStringTime;
         lastStringTime = newStringTime;
 ...
 function overlap (element1,element2){
     ...
     //rectnagle of the second element 
